...
document.querySelectorAll('[data-bar-std]').forEach(btn => {
    btn.addEventListener('click', () => {
        state.barStdMult = Number(btn.dataset.barStd);
...
document.querySelectorAll('[data-pairs-std]').forEach(btn => {
    btn.addEventListener('click', () => {
        state.pairsStdMult = Number(btn.dataset.pairsStd);
